...
parser MyParser(packet_in packet,
    ...
    state parse_ethernet {
        ...
        /*
         *MODIFICAR AQUI
         *Modify the next line to select on hdr.ethernet.etherType
         *If the values is TYPE_SRCROUTING transition to parse_srcRouting
    ...
    state parse_srcRouting {
        /*
        *MODIFICAR AQUI
        *extract the next entry of hdr.srcRoutes
...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.srcRoutes[0].isValid()){
             ...
             *MODIFICAR AQUI
             *add logic to:
             *-If final srcRoutes (top pf stack has bos==1):
